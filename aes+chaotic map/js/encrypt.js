...
async function encryptAndUpload() {
    ...
    reader.onload = async function(event) {
        ...
        const keyString = arrayBufferToHex(keyData);
        const uid = generateUID();
        // Display encrypted data and key in HTML
        document.getElementById('uid').textContent = "Uid:"+uid;
        document.getElementById('aesKey').textContent ="Key:"+ keyString;
        ...
        // Push the encrypted image data and UID to the database
        databaseRef.push({
            uid: uid,
        ...
        // Optionally, you can also store the encryption key securely or use it to encrypt a separate key for storage.
    };
